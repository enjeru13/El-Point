import {
  ...
  Hamburger, Croissant, Donut, Cookie, Beef, Egg, EggFried, Fish,
  Apple, Cherry, Carrot, Soup, CupSoda, Beer, Wine, Milk, Popcorn,
  Salad, IceCreamCone, Cake, Candy, Grape, Citrus, Nut, Ham, Drumstick,
  type LucideIcon,
