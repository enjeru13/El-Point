...
const light: ThemePalette = {
  ...
  // Ámbar dorado — hace juego con la brasa del primary y con el dorado que
  // ya usábamos en la insignia de Original/crown (antes era un verde-teal
  // que no encajaba con el resto de la paleta).
  secondary: "#9a6a00",
  onSecondary: "#ffffff",
  secondaryContainer: "#f5dfa8",
  onSecondaryContainer: "#4a3400",
  tertiary: "#6f5092",
  onTertiary: "#ffffff",
...
const dark: ThemePalette = {
  ...
  secondary: "#f0c260",
  onSecondary: "#1a1200",
  secondaryContainer: "#3d2f12",
  onSecondaryContainer: "#f5dfa8",
  tertiary: "#b9a3e8",
  onTertiary: "#12121a",
