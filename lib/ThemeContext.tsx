...
function buildShadow(C: ThemePalette): ShadowMap {
  ...
  return {
    sm:      { ...base, shadowColor: '#1c1b1b', shadowOffset: { width: 3, height: 3 }, elevation: 4 },
    md:      { ...base, shadowColor: '#1c1b1b', shadowOffset: { width: 4, height: 4 }, elevation: 6 },
    lg:      { ...base, shadowColor: '#1c1b1b', shadowOffset: { width: 6, height: 6 }, elevation: 8 },
    primary: { ...base, shadowColor: C.primary, shadowOffset: { width: 4, height: 4 }, shadowOpacity: 0.5, elevation: 6 },
  };
}
